function [epoched_data] = epoch_hyperscanning_data(set_name, onset_marker, offset_marker)
   
    % Load the EEG dataset
    datapath = 'D:\Engaging Speech Project\hyperProject\3_processing\ready_data_v0';
